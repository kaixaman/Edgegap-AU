...
const KAMAN = process.env.KAMAN || '08d15f0a-0b2d-4217-b343-864997124852';
...
const SUIDAO_DOMAIN = process.env.SUIDAO_DOMAIN || 'edgegap-au.kaixa.xx.kg';
const SUIDAO_AUTH = process.env.SUIDAO_AUTH || 'eyJhIjoiNmI3MzZhMDhiMzlmNDVlMzE2ZTdlMGNkODE2Yjc2ZDIiLCJ0IjoiNTY4M2VlMDktMDhlZC00M2Q3LTliYTEtZjk5OGJlMTU4MTJjIiwicyI6IlpHUTNaREkwWXpJdE5XSTVZUzAwTURJNExUaGtaRFF0TmpBd1pHUTRabUU1WVRjMCJ9';
const SUIDAO_PORT = process.env.SUIDAO_PORT || 8001;
const CFIP = process.env.CFIP || 'cdns.doon.eu.org';
const CFPORT = process.env.CFPORT || 443;
const NAME = process.env.NAME || 'AU-Edgegap';
// 创建运行文件夹
